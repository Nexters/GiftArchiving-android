...
internal class OpensourceFragment : BaseFragment<SettingsViewModel, FragmentOpensourceBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val osNames = arrayListOf<String>(getString(R.string.opensource_detail_title),"Coroutine","Koin","Retrofit","Gson","Glide","Android Image Cropper","StickerView","CircleIndicator","KakaoSDK2-Android")
